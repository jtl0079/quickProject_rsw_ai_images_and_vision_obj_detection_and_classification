import cv2
import numpy as np
from rsw_ai.backend.draw_triangle import *
...
def create_triangle_image(
    ...
    """
    Create an image containing an equilateral triangle and save it to a file.
    ...
    center : tuple[int, int] | None
        ...
        If None, the triangle will be placed at the center of the image.
    side_length : int
        Length of each side of the equilateral triangle.
    rotation : float
        Rotation angle in degrees (counter-clockwise around triangle center).
    ...
    thickness : int
        Thickness of the triangle border. Use -1 to create a filled triangle.
